...
REM
REM Generated by Vivado on Sat Feb 07 11:57:58 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_systolic_array_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_systolic_array_vlog.prj -log xvlog.log
